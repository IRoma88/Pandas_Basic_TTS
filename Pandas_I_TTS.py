# -*- coding: utf-8 -*-
"""Facil de Enunciado Proyecto final Pandas I.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mBlVwrJjde_sQDdfOiTquASex6_TqnCz
"""
...
correct = str(solucion_1)+str(solucion_2b)+str(solucion_3)+str(solucion_3b)+str(solucion_4)+str(solucion_5)+str(solucion_6)+str(solucion_7)+str(test.head(10))+str(test_cleaned.tail(10))
pwd = hashlib.sha256(str(correct).encode())
#print('El token para corregir en Nodd3r es:\n',pwd.hexdigest())
if pwd.hexdigest()[0:6] == '2f459b':
